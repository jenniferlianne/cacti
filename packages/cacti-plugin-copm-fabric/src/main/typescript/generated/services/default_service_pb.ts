...
/**
 * @generated from message org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.services.defaultservice.ClaimLockedAssetV1Request
 */
export class ClaimLockedAssetV1Request extends Message<ClaimLockedAssetV1Request> {
  /**
   *
   *
   * @generated from field: org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.AssetLockClaimV1PB assetLockClaimV1PB = 1;
   */
  ...
  static readonly typeName = "org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.services.defaultservice.ClaimLockedAssetV1Request";
...
/**
 * @generated from message org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.services.defaultservice.ClaimPledgedAssetV1Request
 */
export class ClaimPledgedAssetV1Request extends Message<ClaimPledgedAssetV1Request> {
  /**
   *
   *
   * @generated from field: org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.AssetPledgeClaimV1PB assetPledgeClaimV1PB = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.services.defaultservice.ClaimPledgedAssetV1Request";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.services.defaultservice.LockAssetV1Request
 */
export class LockAssetV1Request extends Message<LockAssetV1Request> {
  /**
   *
   *
   * @generated from field: org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.AssetLockV1PB assetLockV1PB = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "org.hyperledger.cacti.plugin.cacti.plugin.copm.fabric.services.defaultservice.LockAssetV1Request";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
