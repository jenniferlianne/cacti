...
describe("PluginCopmFabric", () => {
  ...
  beforeAll(async () => {
    ...
    cordaTestnet = new CopmWeaverCordaTestnet(addressInfoHttp.address, log);
...
*/
    ...
    [net1, net2] = ["Corda_Network", "Corda_Network2"];
    [user1, user2] = ["O=PartyA, L=London, C=GB", "O=PartyB, L=London, C=GB"];
    ...
    const lockResult = await client.lockAssetV1(
      new LockAssetV1Request({
        assetLockV1PB: {
          ...
          destinationCertificate: u2n1.userId,
        },
      }),
    );
